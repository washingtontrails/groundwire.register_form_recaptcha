...
from groundwire.register_form_recaptcha.widget import RecaptchaWidget
...
class RecaptchaRegistrationForm(RegistrationForm):
    ...
    def form_fields(self):
        form_fields = super(RecaptchaRegistrationForm, self).form_fields
    ...
    def validate_registration(self, action, data):
        errors = super(RecaptchaRegistrationForm, self).validate_registration(action, data)
